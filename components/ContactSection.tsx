...
export default function ContactSection() {
  ...
  return (
    <section id="contact" className="min-h-screen bg-[#f5f5f5] py-20 px-8 md:px-12 flex items-center relative overflow-hidden">
      ...
      <svg className="absolute top-0 left-0 w-full h-full opacity-5" preserveAspectRatio="none" viewBox="0 0 1440 800">
        <path 
          fill="#3f031c" 
          d="M0,400 C320,300 420,500 740,400 C1060,300 1140,500 1440,400 L1440,800 L0,800 Z"
        />
        <path 
          fill="#3f031c" 
          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                <div className="w-12 h-12 bg-[#e8cca1]/30 rounded-lg flex items-center justify-center flex-shrink-0">
