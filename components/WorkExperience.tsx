  ...
  return (
    <div className="relative flex gap-4 md:gap-8 group">
      ...
      <div className="flex flex-col items-center">
        ...
        {/* Vertical line */}
        {!isLast && <div className="w-0.5 flex-1 bg-linear-to-b from-[#3f031c]/40 to-[#3f031c]/10 min-h-[200px]" />}
      </div>
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 md:gap-6 mb-6">
            ...
            <div className="flex items-start gap-3 md:gap-6 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-base md:text-lg font-semibold text-gray-700 wrap-break-word">
                  {position}
                </p>
              </div>
            </div>
            ...
            <div className="flex flex-col md:items-end gap-2 text-xs md:text-sm text-gray-600 shrink-0">
          ...
          <ul className="space-y-2">
            {description.map((item, index) => (
              <li key={index} className="text-gray-700 text-sm leading-relaxed flex">
                <span className="mr-3 text-[#e8cca1] font-bold shrink-0">・</span>
                <span>{item}</span>
              </li>
            ))}
          </ul>
